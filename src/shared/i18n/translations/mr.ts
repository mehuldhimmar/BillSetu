...
export const mr: Translations = {
  ...
  settings: {
    ...
    shareMessage: 'BillSetu सह सेकंदात व्यावसायिक GST इनव्हॉइस तयार करा! आत्ता डाउनलोड करा: https://play.google.com/store/apps/details?id=com.billsetu',
  ...
  businessProfile: {
    ...
    businessNameLocked: 'व्यवसायाचे नाव एकदा जतन केल्यानंतर बदलता येत नाही',
  ...
  invoice: {
    ...
    billFrom: 'बिल प्रेषक',
    billFromEmpty: 'व्यवसाय प्रोफाइल सेट केलेली नाही',
    ...
    phoneError: '10 अंकी वैध फोन नंबर प्रविष्ट करा',
    customerAddress: 'पत्ता',
    customerAddressPlaceholder: 'पत्ता प्रविष्ट करा',
    invoiceNumber: 'इनव्हॉइस नंबर',
    invoiceDate: 'इनव्हॉइस तारीख',
    items: 'वस्तू',
    noItems: 'कोणत्याही वस्तू नाहीत',
    noCustomer: 'कोणताही ग्राहक नाही',
    itemCount_one: 'वस्तू',
    itemCount_other: 'वस्तू',
    addItem: 'वस्तू जोडा',
  ...
  invoiceHistory: {
    ...
    searchPlaceholder: 'इनव्हॉइस क्र. किंवा ग्राहकाने शोधा…',
    deleteConfirm: 'इनव्हॉइस हटवा',
    deleteMessage: 'तुम्हाला खरोखर ही इनव्हॉइस हटवायची आहे का?',
    deleteCannotUndo: 'हे पूर्ववत करता येणार नाही.',
    invoiceCount_one: 'इनव्हॉइस',
    invoiceCount_other: 'इनव्हॉइस',
    noResults: 'कोणतेही परिणाम आढळले नाहीत',
    noResultsSubtitle: 'वेगळा शोध शब्द वापरून पहा',
  ...
  gstCalculator: {
    ...
    reset: 'रीसेट',
    disclaimer: 'GST दर सुविधेसाठी प्रदान केले आहेत. अधिकृत GST माहिती: https://www.gst.gov.in/ BillSetu कोणत्याही सरकारी प्राधिकरणाशी संलग्न नाही.',
