export const en = {
  ...
  businessProfile: {
    ...
    businessNameLocked: 'Business name cannot be changed once saved',
  ...
  invoice: {
    ...
    billTo: 'Bill To',
    billFrom: 'Bill From',
    billFromEmpty: 'No business profile set up',
  ...
  invoiceHistory: {
    ...
    invoiceCount_one: 'invoice',
    invoiceCount_other: 'invoices',
